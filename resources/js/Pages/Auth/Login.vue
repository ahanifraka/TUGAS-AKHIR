...
function renderTurnstile() {
    ...
    if (!siteKey) {
        captchaError.value =
            "Captcha is not configured. Contact administrator.";
        return;
    }
    ...
    <AuthLayout>
        ...
        <div class="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 md:p-10">
            <div class="text-center mb-8">
                <Link
                    href="/"
                    class="flex items-center gap-2 md:gap-4 mb-4 no-underline justify-center"
                >
                    <img
                        :src="
                            theme === 'dark'
                                ? '/images/logo-bpbumd-dark.png'
                                : '/images/logo-bpbumd.png'
                        "
                        alt="Logo Badan Pembinaan BPBUMD"
                        class="h-12 md:h-16"
                        title="Logo Badan Pembinaan BPBUMD"
                    />
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mt-4">
                    ...
                    <InputError
                        ...
                        :message="form.errors.turnstile_token || captchaError"
                    />
                </div>
