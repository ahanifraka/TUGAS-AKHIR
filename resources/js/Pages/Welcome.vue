    ...
    infoDots: [
        {
            ...
            description: t(
                ...
                "Kegiatan yang berkaitan dengan perjalanan dan kunjungan ke berbagai destinasi."
            ),
        ...
        },
        {
            ...
            description: t(
                ...
                "Segala sesuatu yang berkaitan dengan produksi dan penyediaan makanan."
            ),
        ...
        },
        {
            ...
            description: t(
                ...
                "Segala hal terkait kepemilikan, pengelolaan, dan penggunaan bangunan atau lahan."
            ),
        ...
        },
        {
            ...
            description: t(
                ...
                "Upaya memindahkan orang atau barang dari satu tempat ke tempat lain."
            ),
        ...
        },
        {
            ...
            description: t(
                ...
                "Aktivitas yang mengatur dan mengelola uang serta transaksi ekonomi."
            ),
        ...
        },
        {
            ...
            description: t(
                ...
                "Layanan dasar yang menunjang kehidupan seperti air, listrik, dan telekomunikasi."
            ),
            thumbnails: (
            ...
            >
                ...
                >
                    ...
                    <img
                        ...
                        :class="[
                            'w-full h-full object-cover banner-image',
                            loadedImages.has(`slider-${item.id}`)
                                ? 'image-fade-in'
                                : '',
                        ]"
                    />
                ...
                <template #container-end>
                    ...
                    >
                        <button
                            type="button"
                            aria-label="Prev"
                            class="swiper-button-prev !text-white !w-4 !h-4 xs:!w-8 xs:!h-6 sm:!w-6 sm:!h-8 !mt-0 hover:!text-gray-300 transition-colors duration-300 hidden xs:flex"
                        ></button>
                    </div>
                    <div
                    ...
                    >
                        <button
                            type="button"
                            aria-label="Next"
                            class="swiper-button-next !text-white !w-4 !h-4 xs:!w-8 xs:!h-6 sm:!w-6 sm:!h-8 !mt-0 hover:!text-gray-300 transition-colors duration-300 hidden xs:flex"
                        ></button>
                    </div>
                </template>
            </Swiper>
        ...
        >
            ...
            >
                ...
                <div class="p-4">
                    ...
                    >
                        <SwiperSlide
                            v-for="item in berita_populer.data"
                            :key="item.id"
                        >
                            <div
                            ...
                            >
                                ...
                                <div class="p-4">
                                    ...
                                    >
                                        <h3
                                            class="text-normal font-bold mb-2 hover:text-primary"
                                        >
                                            {{
                                                (
                                                    localizeField(
                ...
                >
                    ...
                    >
                        <Link
                            ...
                            v-for="item in bumd.data"
                            :key="item.id"
                        >
                            <figure
                                class="w-full h-full mx-auto rounded overflow-hidden dark:bg-white"
                            >
                                <template
        ...
        <section id="Galeri" class="px-4 py-24 bg-gray-50 dark:bg-gray-900">
            <div class="w-full">
                ...
                >
                    ...
                    >
                        <Link
                            :href="route('albums.showPublic', album.data[0].id)"
                            :title="
                                localizeField(
                        ...
                        >
                            ...
                            ></div>
                            <div
                                class="absolute bottom-0 left-0 right-0 pb-6 px-4 md:px-4 text-white"
                            >
                                <p
                                    class="text-xs md:text-sm text-gray-200 mb-1 md:mb-2"
                                >
                                    {{
                                        new Date(
                                ...
                                <h3
                                    class="font-bold text-sm md:text-lg lg:text-xl line-clamp-2 drop-shadow-lg"
                                >
                                    {{
                                        localizeField(
                                            album.data[0].title_translations,
                    ...
                    >
                        ...
                        >
                            ...
                            ></div>
                            <div
                                class="absolute bottom-0 left-0 right-0 pb-6 px-4 md:px-3 text-white"
                            >
                                <p
                                    class="text-xs text-gray-200 mb-1 hidden md:block"
                                >
                                    {{
                                        new Date(
                                ...
                                <h3
                                    class="font-bold text-xs md:text-sm lg:text-base line-clamp-2 drop-shadow-lg"
                                >
                                    {{
                                        localizeField(
                                            album.data[1].title_translations,
